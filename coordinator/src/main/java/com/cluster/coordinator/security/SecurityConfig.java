                ...
                if (username.equals(name) && password.equals(credentials)) {
                    java.util.List<org.springframework.security.core.GrantedAuthority> authorities =
                            java.util.List.of(
                                    ...
                                    new org.springframework.security.core.authority
                                            .SimpleGrantedAuthority("ROLE_WORKER"));
                    return new org.springframework.security.authentication
                            .UsernamePasswordAuthenticationToken(name, credentials, authorities);
                }

                // Enrolled worker auth
                if (!username.equals(name)) {
                    com.cluster.coordinator.model.Worker worker =
                            workerRepository.findById(name).orElse(null);

package com.cluster.coordinator;
...
public class MessageSerializationTest {
    ...
    public void testMessageEnvelopeInstantSerialization() throws Exception {
        MessageEnvelope<HeartbeatMessage> envelope = MessageEnvelope.<HeartbeatMessage>builder()
        ...
        MessageEnvelope<Map<String, Object>> deserialized = objectMapper.readValue(
        ...
        HeartbeatMessage payload = objectMapper.convertValue(deserialized.getPayload(), HeartbeatMessage.class);
    ...
    public void testTaskAssignmentMessageRoundTrip() throws Exception {
        TaskAssignmentMessage assignMsg = TaskAssignmentMessage.builder()
                .taskId("task-1")
                .jobId("job-1")
                .taskType("compute")
        ...
        TaskAssignmentMessage payload = objectMapper.convertValue(deserialized.getPayload(), TaskAssignmentMessage.class);

...
class WorkerMessageControllerTest {
    ...
    @Mock private com.cluster.coordinator.service.TaskExecutionService taskExecutionService;
    ...
    void handleResourceUpdate_WithValidValues_UpdatesResourcesAndHeartbeat() {
        ...
        MessageEnvelope<Map<String, Object>> envelope =
                MessageEnvelope.<Map<String, Object>>builder()
        ...
        ArgumentCaptor<ResourceUpdateMessage> resourceCaptor =
                ArgumentCaptor.forClass(ResourceUpdateMessage.class);
        ...
        ArgumentCaptor<WorkerHeartbeatRequest> heartbeatCaptor =
                ArgumentCaptor.forClass(WorkerHeartbeatRequest.class);

...
@TestPropertySource(properties = {
        "cluster.coordinator.advertised-url=http://192.168.1.200:8080"
})
public class ClusterEnrollmentSpringBootTest {
    ...
    public void testEnrollWorker_UsesConfiguredPropertyInSpringContext() {
        ...
        ClusterEnrollmentService.EnrollmentResult result = enrollmentService.enrollWorker(joinCode, "spring-test-worker");

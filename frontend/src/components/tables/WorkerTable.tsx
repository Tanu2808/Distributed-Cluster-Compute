                  ...
                  {isOffline ? (
                    ...
                    <div>
                      <p className="text-xs text-slate-400 mb-1">
                        {Math.round(
                          (worker.cpuCores * worker.cpuUsagePercent) / 100,
                        )}
                      ...
                      <MiniBar
                        ...
                        max={100}
                        color={
                          worker.cpuUsagePercent > 85
                            ? "bg-red-500"
                            : worker.cpuUsagePercent > 60
                              ? "bg-amber-500"
                              : "bg-cyan-500"
                        }
                      />
                ...
                <td className="py-3 px-4">
                  {isOffline ? (
                    ...
                    <div>
                      <p className="text-xs text-slate-400 mb-1">
                        {Math.round(
                          (worker.memoryRamMb * worker.memoryUsagePercent) /
                            100000,
                        )}

...
public class SettingsController {
    ...
    public SettingsController(WorkerConfigurationStore configStore, WorkerStateManager stateManager) {
    ...
    public ResponseEntity<Map<String, Object>> getClusterSettings() {
        ...
        return ResponseEntity.ok(Map.of(
            ...
            "clusterName", config.getClusterName() != null ? config.getClusterName() : "",
            "coordinatorUrl", config.getCoordinatorUrl() != null ? config.getCoordinatorUrl() : "",

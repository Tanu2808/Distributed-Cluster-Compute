...
public class ClusterControllerTest {
    ...
    public void testJoinCluster_Unavailable() throws Exception {
        when(setupService.joinCluster(any()))
                .thenReturn(
                        ...
                        post("/api/cluster/join")
                                ...
                                .content(
                                        objectMapper.writeValueAsString(
                                                Map.of("joinCode", "ABCD-1234-EFGH-5678"))))
    ...
    public void testCreateCluster_Local() throws Exception {
        when(setupService.createCluster("my-cluster", true))
                .thenReturn(new ClusterConfiguration("my-cluster", null));

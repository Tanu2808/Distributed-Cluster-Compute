...
export const MetricCard: React.FC<MetricCardProps> = ({
  ...
  if (
    ...
    status === "critical" ||
    (progressPercent !== undefined && progressPercent >= 90)
  ) {
  ...
  return (
    <div
      className={`bg-console-surface border border-console-border rounded-sm p-3.5 flex flex-col justify-between ${className}`}
    >

...
export const StatusBadge: React.FC<StatusBadgeProps> = ({
  ...
  } else if (['BUSY', 'CONNECTING', 'REGISTERING', 'RECONNECTING', 'SETUP_REQUIRED', 'VALIDATING', 'INITIALIZING'].includes(s)) {
  ...
  } else if (['DISCONNECTED', 'OFFLINE', 'FAILED', 'CANCELLED', 'REJECTED'].includes(s)) {
